...
public class InitSplashActivity extends AppCompatActivity {
    ...
    public void saveProducts(){
        ...
        validateProduct(new Products("Queso Mozarella",2800,"queso_mozarella",40,2,3,2,1));
        validateProduct(new Products("Queso Almendras",3600,"queso_finesse",40,2,4,2,1));
        ...
        validateProduct(new Products("Galleta chips de chocolate",1500,"galleta",10,8,10,1,1));
    }
